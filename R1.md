...
### Day 40: May 12, Wednesday

**Today's Progress** : Done with styling and adding related componenst on all screen of the project
...
### Day 41: May 14, Friday

**Today's Progress** : Searched some free API and read some code related to how to fetch api and look for best practice to implement it on #reactnative

**Thoughts**: Will make more fake project with different complication and feratures.

**Link to work**:

### Day 42-43: May 15-16, Saturday-Sunday

**Today's Progress** : Fixing my personal website using reactjs.

**Thoughts**: Will make more fake project with different complication and feratures.

**Link to work**:

### Day 44-45: May 18-19, Tuesday-Wednesday

**Today's Progress** : still trying to fix my existing personal website using #React, trying to implement component-compound style.

**Thoughts**: Will make more fake project with different complication and feratures.

**Link to work**:

### Day 46: May 23, Sunday

**Today's Progress** : Adding mobile media query with styled component in my react portfolio project.

**Thoughts**: Will make more fake project with different complication and feratures.

**Link to work**:

### Day 47-48: May 24-25, Monday-Tuesday

**Today's Progress** : Finishing all media query that required in my react portfolio project.

**Thoughts**: Will make more fake project with different complication and feratures.

**Link to work**: [React Profile Web Yaltha](https://github.com/yaltha/react-profile-web-yaltha)

### Day 49: May 26, Wednesday

**Today's Progress** : Adding a page that show my level of familiarity with some tech stacks.

**Thoughts**: Will make more fake project with different complication and feratures.

**Link to work**: [React Profile Web Yaltha](https://github.com/yaltha/react-profile-web-yaltha)

### Day 50: May 29, Saturday

**Today's Progress** : Today I have not been initiated my new project yet instead I try to deploy my previous #ReactNative project, Rent Car App, to my Expo repo. Hopefully tomorrow I'd start a new one.
...
### Day 51-52: June 2 - June 3, Wednesday - Thursday

**Today's Progress** : Today I am starting to design my new #reactnative project. Using #figma and learning and reading some aspect of UI/UX aspecs for a better mobile apps.

**Thoughts**: I think a fake project or self peoject could improve my skills further.

**Link to work**:

### Day 53-54: June 4 - June 5, Friday - Saturday

**Today's Progress** : Finishing with the app UI design and created initial react native file for the project.

**Thoughts**: I think that knowing basic UI/UX design and implemented them in my personal project is an awesome skill to be always learn and enhanced.

**Link to work**:

- [Hospital Queue Ticket App](https://github.com/yaltha/hospital-queue-ticket-app)
- [project-design](https://www.figma.com/file/GvtYI4ohTFgcrqOFSENz6T/Hospital-Queue-Ticket?node-id=0%3A1)

### Day 55-56: June 6 - June 7, Sunday - Monday

**Today's Progress** : Done with the fill form from one of the screen in this project and adding some changing on UI design in figma.
...
### Day 57-58: June 8 - June 9, Tuesday - Wednesday

**Today's Progress** : Finishing styling all screen in my project and using typescript and adding react navigation so that all screen currently connected.  
